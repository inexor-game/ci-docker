...
RUN apt-get update \
    ...
    && apt-get -y --no-install-recommends install libpangocairo-1.0-0 libxcomposite libxrandr2 libatk1.0-0 libcups2 libnss3 libgconf-2-4 libxss1 libasound2 libxtst6 \
