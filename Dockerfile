...
RUN apt-get update
RUN apt-get -y install sudo binutils build-essential cmake doxygen libboost-all-dev libenet-dev libgconf2-dev libsdl2-dev libsdl2-image-dev libsdl2-mixer-dev libudev-dev zlib1g-dev wget
