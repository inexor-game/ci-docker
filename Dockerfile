...
RUN apt-get update \
    ...
    && apt-get -y --no-install-recommends install python libfontconfig1 libfreetype6 libnss3 libxcomposite1 libxtst6 libgconf-2-4 libcups2 libcairo2 libpango-1.0-0 libpangocairo-1.0-0 \
